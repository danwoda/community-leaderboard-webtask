module.exports = async (ctx, cb) => {
  ...
  async function getLeaderboardRows() {
    ...
    try {
      ...
      console.error(error)
      cb(null, { text: `¯\\_(ツ)_/¯  Oops...there was an error. Please contact <#C3CQQB475> for more info.` })
    }
  }
